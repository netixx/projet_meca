...
TEB= [1.17 3.35; 1.29 4.40; 1.34 4.83; 1.43 5.39; 1.66 6.50; 1.90 7.80; 2.49 9.78; 3.01 12.82; 3.39 14.67; 3.73 17.27; 4.08 20.31; 4.24 22.17; 4.47 24.96];
...
Data= [I2 dW];
[phat, yhat, stat]=nlinregr(Data, Names, HomoFun, dHomoFun, pDef, 'y', 1, pInit);
I2= min(I2):0.1:max(I2)*1.1;
dW= Homo(phat,I2);
plot2d(I2, dW, rect = [0, 0, max(I2)*1.1, max(dW)*1.1], style = 2);
disp('A = ' + string(phat(1)) + ', B = ' + string (phat(2)));
// A = 8.3711453, B = -2.1941321 
